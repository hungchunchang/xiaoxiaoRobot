...
public class CustomRobotEventListener implements RobotEventListener {
    ...
    public CustomRobotEventListener(NuwaRobotAPI robotAPI, MessagesViewModel messagesModelView, SocketHandler socketHandler) {
    ...
    public void onWikiServiceStart() {
        ...
        mRobotAPI.registerVoiceEventListener(new CustomVoiceEventListener(mRobotAPI, messagesViewModel, socketHandler));
